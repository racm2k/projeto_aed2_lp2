 ...
 *  @author Kevin Wayne
 */
public class EdgeWeightedDigraphAED2 {
     ...
     */
    public EdgeWeightedDigraphAED2(int V) {
     ...
     */
    public EdgeWeightedDigraphAED2(int V, int E) {
        this(V);
        ...
        for (int i = 0; i < E; i++) {
            ...
            double time = 0.01 * StdRandom.uniform(60);
            DirectedEdge e = new DirectedEdge(v, w, weight, time);
            addEdge(e);
        }
    }
     ...
     */
    public EdgeWeightedDigraphAED2(In in) {
        ...
        try {
            ...
            for (int i = 0; i < E; i++) {
                ...
                addEdge(new DirectedEdge(v, w, weight, time));
            }
        }
     ...
     */
    public EdgeWeightedDigraphAED2(EdgeWeightedDigraphAED2 G) {
        this(G.V());
        this.E = G.E();
        for (int v = 0; v < G.V(); v++)
    ...
    public String toString() {
        ...
        for (int v = 0; v < V; v++) {
            s.append(v + ": ");
            for (DirectedEdge e : adj[v]) {
                s.append(e + "  " + timeFormat.format(e.time())+"mins ; ");
            }
            s.append(NEWLINE);
        }
        return s.toString();
    ...
    public static void main(String[] args) {
        In in = new In(args[0]);
        EdgeWeightedDigraphAED2 G = new EdgeWeightedDigraphAED2(in);
        StdOut.println(G);
    }
