...
public class DijkstraSP_AED2 {
     ...
     */
    public DijkstraSP_AED2(EdgeWeightedDigraphAED2 G, int s) {
    ...
    private boolean check(EdgeWeightedDigraphAED2 G, int s) {
    ...
    public static void main(String[] args) {
        ...
        DijkstraSP_AED2 sp = new DijkstraSP_AED2(G, s);
